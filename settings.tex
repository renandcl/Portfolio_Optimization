...
\usepackage[labelsep=endash]{caption} % captions for figures, tables etc, caption label separator '-'
...
\usepackage[automake,nonumberlist,acronym,nogroupskip]{glossaries} % glossary and acronyms list
\usepackage[alf,abnt-repeated-title-omit=no,abnt-emphasize=bf,abnt-full-initials=no,abnt-doi=doi,abnt-etal-list=0,abnt-etal-cite=3]{abntex2cite}
\citebrackets() % parenthesis brackets for citations

\renewcommand{\glsnamefont}[1]{#1} % glossary and acronyms list
...
\lstset{style=code_style} % code style
